...
import { Search, Wallet, Activity, Image, Loader2, ExternalLink, Copy, Check, Users, Globe, Twitter, Github, Calendar, Zap } from "lucide-react";
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white/5 rounded-lg p-3 text-center">
                    <div className="text-xl font-bold text-white">{profile.tokenCount}</div>
                    <div className="text-xs text-gray-400">Tokens</div>
                  </div>
                  <div className="bg-white/5 rounded-lg p-3 text-center">
                    <div className="text-xl font-bold text-white">{profile.nftCount}</div>
                    <div className="text-xs text-gray-400">NFTs</div>
                  </div>
                </div>

                {profile.walletAgeDays > 0 && (
                  <div className="flex items-center gap-2 py-2 border-t border-white/5">
                    ...
                    <span className="text-white text-sm">{profile.walletAgeDays} days</span>
                  </div>
                )}
                ...
                {profile.defiProtocols && profile.defiProtocols.length > 0 && (
                  <div className="pt-2 border-t border-white/5">
                    <div className="text-sm text-gray-400 mb-2">DeFi Protocols</div>
                    <div className="flex flex-wrap gap-2">
                      {profile.defiProtocols.map((protocol, i) => (
                        <span key={i} className="px-2 py-1 text-xs bg-yellow-500/20 text-yellow-300 rounded-full border border-yellow-500/30">
                          {protocol}
                        </span>
                      ))}
                    </div>
